...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR gold][B]MPZ MATRIX[/B][/COLOR]'
BUILDERNAME = 'MPZ MATRIX'
EXCLUDES = [ADDON_ID, 'repository.MPZmatrix']
# Text File with build info in it.
BUILDFILE = 'https://pastebin.com/raw/EXfHVRq5'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]MPZ MATRIX [/B][/COLOR][COLOR {color2}]Wizard Matrix[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Gracias por elegir MPZ MATRIX'
