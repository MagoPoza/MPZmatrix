    ...
    def get_listing(self):
        ...
        if len(CONFIG.BUILDNAME) > 0:
            ...
            if version > CONFIG.BUILDVERSION:
                build = '{0} [COLOR green][B][ACTUALIZACION v{1}][/B][/COLOR]'.format(build, version)
        ...
        if (tools.platform() == 'android' or CONFIG.DEVELOPER == 'true'):
            directory.add_dir('Instalar APKs', {'mode': 'apk'}, icon=CONFIG.ICONAPK, themeit=CONFIG.THEME1)
        ...
        directory.add_dir('Salvar Datos', {'mode': 'savedata'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
        ...
        directory.add_file('Ver errores del Log: {0}'.format(errorsfound), {'mode': 'viewerrorlog'}, icon=CONFIG.ICONMAINT,
                           themeit=CONFIG.THEME1)
        if errors > 0:
            directory.add_file('Ver errores del Log', {'mode': 'viewerrorlast'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME1)
        directory.add_separator()
        ...
        if tools.open_url(CONFIG.ADDONFILE, check=True) or os.path.exists(os.path.join(CONFIG.ADDON_PATH, 'resources', 'text', 'addons.json')):
            directory.add_dir('Instalador de Addons', {'mode': 'addons'}, icon=CONFIG.ICONADDONS, themeit=CONFIG.THEME1)
        directory.add_dir('Telegram', {'mode': 'saveda'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
