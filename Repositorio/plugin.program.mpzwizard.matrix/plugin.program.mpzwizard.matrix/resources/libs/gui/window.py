    ...
    class FirstRun(xbmcgui.WindowXMLDialog):
        ...
        def onInit(self):
            ...
            self.controllist = [self.trakt, self.debrid, self.login,
                                    ...
                                    self.thumbs]
            self.controlsettings = ['mantener trakt', 'mantener debrid', 'mantener login',
